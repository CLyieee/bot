...
const { getDisplayName, formatNumber, checkCooldown } = require("../utils/helpers");
const {
  EmbedBuilder,
  ActionRowBuilder,
  ButtonBuilder,
...
const RESOURCES = {
  forest: [
    { name: "Wood", emoji: "🪵", image: "https://www.dododex.com/media/item/Wood.png", chance: 80, amount: [5, 15] },
    { name: "Thatch", emoji: "🌿", image: "https://www.dododex.com/media/item/Thatch.png", chance: 75, amount: [5, 20] },
    { name: "Fiber", emoji: "🧶", image: "https://www.dododex.com/media/item/Fiber.png", chance: 70, amount: [10, 25] },
    { name: "Berry", emoji: "🍇", image: "https://www.dododex.com/media/item/Mejoberry.png", chance: 65, amount: [5, 15] },
    { name: "Hide", emoji: "🧶", image: "https://www.dododex.com/media/item/Hide.png", chance: 50, amount: [3, 10] },
    { name: "Chitin", emoji: "🪲", image: "https://www.dododex.com/media/item/Chitin.png", chance: 25, amount: [2, 8] },
    { name: "Rare Flower", emoji: "🌸", image: "https://www.dododex.com/media/item/Rare_Flower.png", chance: 10, amount: [1, 3] },
    { name: "Rare Mushroom", emoji: "🍄", image: "https://www.dododex.com/media/item/Rare_Mushroom.png", chance: 10, amount: [1, 3] },
  ],
  mountain: [
    { name: "Stone", emoji: "🪨", image: "https://www.dododex.com/media/item/Stone.png", chance: 80, amount: [10, 20] },
    { name: "Metal", emoji: "🔩", image: "https://www.dododex.com/media/item/Metal.png", chance: 60, amount: [3, 10] },
    { name: "Crystal", emoji: "💎", image: "https://www.dododex.com/media/item/Crystal.png", chance: 40, amount: [2, 8] },
    { name: "Obsidian", emoji: "⬛", image: "https://www.dododex.com/media/item/Obsidian.png", chance: 35, amount: [2, 7] },
    { name: "Pelt", emoji: "🧥", image: "https://www.dododex.com/media/item/Pelt.png", chance: 30, amount: [2, 6] },
    { name: "Silica Pearls", emoji: "🔮", image: "https://www.dododex.com/media/item/Silica_Pearls.png", chance: 20, amount: [1, 5] },
    { name: "Element Shard", emoji: "✨", image: "https://www.dododex.com/media/item/Element_Shard.png", chance: 5, amount: [1, 3] },
  ],
  ocean: [
    { name: "Silica Pearls", emoji: "🔮", image: "https://www.dododex.com/media/item/Silica_Pearls.png", chance: 70, amount: [3, 12] },
    { name: "Oil", emoji: "🛢️", image: "https://www.dododex.com/media/item/Oil.png", chance: 60, amount: [2, 10] },
    { name: "Chitin", emoji: "🪲", image: "https://www.dododex.com/media/item/Chitin.png", chance: 50, amount: [3, 10] },
    { name: "Black Pearl", emoji: "⚫", image: "https://www.dododex.com/media/item/Black_Pearl.png", chance: 20, amount: [1, 5] },
    { name: "Organic Polymer", emoji: "🧪", image: "https://www.dododex.com/media/item/Organic_Polymer.png", chance: 15, amount: [1, 4] },
    { name: "Ambergris", emoji: "🟠", image: "https://www.dododex.com/media/item/Ambergris.png", chance: 8, amount: [1, 2] },
  ],
  desert: [
    { name: "Sand", emoji: "🏜️", image: "https://www.dododex.com/media/item/Sand.png", chance: 85, amount: [15, 30] },
    { name: "Stone", emoji: "🪨", image: "https://www.dododex.com/media/item/Stone.png", chance: 75, amount: [8, 15] },
    { name: "Crystal", emoji: "💎", image: "https://www.dododex.com/media/item/Crystal.png", chance: 35, amount: [2, 7] },
    { name: "Sulfur", emoji: "🟡", image: "https://www.dododex.com/media/item/Sulfur.png", chance: 30, amount: [2, 6] },
    { name: "Silk", emoji: "🧵", image: "https://www.dododex.com/media/item/Silk.png", chance: 25, amount: [1, 5] },
    { name: "Propellant", emoji: "💣", image: "https://www.dododex.com/media/item/Propellant.png", chance: 10, amount: [1, 3] },
    { name: "Death Worm Horn", emoji: "📯", image: "https://www.dododex.com/media/item/Death_Worm_Horn.png", chance: 5, amount: [1, 2] },
  ],
  snow: [
    { name: "Wood", emoji: "🪵", image: "https://www.dododex.com/media/item/Wood.png", chance: 70, amount: [5, 15] },
    { name: "Stone", emoji: "🪨", image: "https://www.dododex.com/media/item/Stone.png", chance: 65, amount: [5, 15] },
    { name: "Pelt", emoji: "🧥", image: "https://www.dododex.com/media/item/Pelt.png", chance: 60, amount: [5, 12] },
    { name: "Oil", emoji: "🛢️", image: "https://www.dododex.com/media/item/Oil.png", chance: 45, amount: [2, 8] },
    { name: "Obsidian", emoji: "⬛", image: "https://www.dododex.com/media/item/Obsidian.png", chance: 40, amount: [2, 7] },
    { name: "Crystal", emoji: "💎", image: "https://www.dododex.com/media/item/Crystal.png", chance: 35, amount: [2, 6] },
    { name: "Polymer", emoji: "⚪", image: "https://www.dododex.com/media/item/Polymer.png", chance: 15, amount: [1, 4] },
    { name: "Woolly Rhino Horn", emoji: "🦏", image: "https://www.dododex.com/media/item/Woolly_Rhino_Horn.png", chance: 5, amount: [1, 2] },
  ],
  cave: [
    { name: "Chitin", emoji: "🪲", image: "https://www.dododex.com/media/item/Chitin.png", chance: 70, amount: [5, 15] },
    { name: "Stone", emoji: "🪨", image: "https://www.dododex.com/media/item/Stone.png", chance: 65, amount: [5, 15] },
    { name: "Crystal", emoji: "💎", image: "https://www.dododex.com/media/item/Crystal.png", chance: 50, amount: [3, 10] },
    { name: "Metal", emoji: "🔩", image: "https://www.dododex.com/media/item/Metal.png", chance: 45, amount: [2, 8] },
    { name: "Obsidian", emoji: "⬛", image: "https://www.dododex.com/media/item/Obsidian.png", chance: 40, amount: [2, 7] },
    { name: "Rare Mushroom", emoji: "🍄", image: "https://www.dododex.com/media/item/Rare_Mushroom.png", chance: 35, amount: [2, 7] },
    { name: "Artifact", emoji: "🏺", image: "https://www.dododex.com/media/item/Artifact.png", chance: 10, amount: [1, 1] },
    { name: "Venom", emoji: "💉", image: "https://www.dododex.com/media/item/Venom.png", chance: 8, amount: [1, 3] },
  ],
};

// Rare special items that can be found on any expedition
const RARE_ITEMS = [
  { name: "Ancient Amber", emoji: "🔶", image: "https://www.dododex.com/media/item/Ancient_Amber.png", chance: 3, amount: [1, 2] },
  { name: "Element Dust", emoji: "✨", image: "https://www.dododex.com/media/item/Element_Dust.png", chance: 2, amount: [1, 5] },
  { name: "Biotoxin", emoji: "☠️", image: "https://www.dododex.com/media/item/Biotoxin.png", chance: 2, amount: [1, 3] },
  { name: "Unicorn Horn", emoji: "🦄", image: "https://www.dododex.com/media/item/Unicorn_Horn.png", chance: 0.5, amount: [1, 1] },
];
...
const BIOMES = {
  forest: {
    name: "Forest",
    emoji: "🌲",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/0/09/Redwoods.jpg",
    description: "Lush forests filled with wood, fiber, and various berries.",
    cooldown: 30 * 60 * 1000, // 30 minutes
    duration: 10 * 60 * 1000, // 10 minutes
    dangerLevel: 1,
    preferredDinos: ["Therizinosaurus", "Brontosaurus", "Stegosaurus", "Mammoth"],
  },
  mountain: {
    name: "Mountain",
    emoji: "⛰️",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/5/5e/Mountains_%28Ragnarok%29.jpg",
  ...
  ocean: {
    name: "Ocean",
    emoji: "🌊",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/a/a4/Ocean_Overview.jpg",
  ...
  desert: {
    name: "Desert",
    emoji: "🏜️",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/f/f3/Scorched_Earth_Panorama.jpg",
  ...
  snow: {
    name: "Snow",
    emoji: "❄️",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/0/0d/Snow.jpg",
  ...
  cave: {
    name: "Cave",
    emoji: "🕳️",
    image: "https://static.wikia.nocookie.net/arksurvivalevolved_gamepedia/images/b/b0/Central_Cave.jpg",
    description: "Dark caverns hiding artifacts, rare mushrooms and dangerous creatures.",
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!collection || Object.keys(collection).length === 0) {
      return message.reply("You don't have any dinosaurs to send on an expedition! Use `!catch` to catch some first.");
    }
    ...
    if (!selectedBiome) {
      return message.reply(`Invalid biome! Available biomes are: ${Object.keys(BIOMES).map(b => `\`${b}\``).join(", ")}`);
    }
    ...
    if (activeExpeditions[selectedBiome.id]) {
      ...
      if (expedition.returnTime > Date.now()) {
        const timeLeft = Math.ceil((expedition.returnTime - Date.now()) / 1000 / 60);
        return message.reply(`Your ${expedition.dinosaur} is still exploring the ${selectedBiome.name}! It will return in approximately ${timeLeft} minutes.`);
      } else {
        // Expedition is complete, collect rewards
        return completeExpedition(message, userId, displayName, selectedBiome.id, expedition);
      }
    }

    // Check for cooldown
    const lastExpeditions = await db.get(`expeditionCooldowns_${userId}`) || {};
    if (lastExpeditions[selectedBiome.id]) {
      const cooldownCheck = checkCooldown(lastExpeditions[selectedBiome.id], selectedBiome.cooldown);
      if (cooldownCheck.onCooldown) {
        return message.reply(`This area is still being replenished with resources! Try again in **${cooldownCheck.timeLeft}**.`);
      }
    }
    ...
    for (const [name, data] of Object.entries(collection)) {
      if (name.toLowerCase() === dinoName.toLowerCase()) {
        ...
        exactMatch = true;
        break;
      } else if (name.toLowerCase().includes(dinoName.toLowerCase()) && !exactMatch) {
        matchedDino = { name, ...data };
      }
    }
    ...
    if (!matchedDino) {
      return message.reply(`You don't have a dinosaur named "${dinoName}". Use \`!dinos\` to see your collection.`);
    }
...
async function showExpeditionMenu(message, userId, displayName) {
  const embed = new EmbedBuilder()
    ...
    .setDescription(`${displayName}, choose a biome to send your dinosaurs on an expedition:`)
  ...
  for (const [biomeId, biomeData] of Object.entries(BIOMES)) {
    embed.addFields({
      ...
      value: `${biomeData.description}\n**Danger Level:** ${"⚠️".repeat(biomeData.dangerLevel)}\n**Cooldown:** ${biomeData.cooldown / (60 * 1000)} minutes\n**Use:** \`!expedition ${biomeId}\``,
      inline: false,
    });
  }
  ...
  if (Object.keys(activeExpeditions).length > 0) {
    ...
    embed.addFields({ name: "🔍 Active Expeditions", value: activeText, inline: false });
  }
...
async function showAvailableDinos(message, userId, displayName, biome) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`${displayName}, choose a dinosaur to send to the ${biome.name.toLowerCase()}:`)
    .setThumbnail(biome.image);
  
  let dinoList = "";
  for (const dino of dinoArray.slice(0, 15)) { // Show up to 15 dinos
    const preferred = isPreferred(dino.name);
    const prefEmoji = preferred ? "⭐ " : "";
    const skillInfo = dino.skill ? ` - ${dino.skill.name}` : "";
    
    dinoList += `${prefEmoji}${rarity_emojis[dino.rarity]} **${dino.name}**${skillInfo}${preferred ? " (Bonus efficiency)" : ""}\n`;
  }
  ...
  embed.addFields(
    ...
    },
    {
      ...
      value: preferredDinos.map(d => `- ${d}`).join("\n") || "None specified.",
      inline: false
    },
    {
      name: "How to Start",
...
async function startExpedition(message, userId, displayName, biome, dinosaur) {
  ...
  const isPreferred = biome.preferredDinos.some(name => dinosaur.name.includes(name));
  if (isPreferred) {
    successChance += 15;
  }
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`${displayName} sent their **${dinosaur.name}** on an expedition to the **${biome.name}**!`)
    .addFields(
      { 
        name: "Expedition Details", 
        value: `🦕 **Dinosaur:** ${dinosaur.name}\n🧭 **Destination:** ${biome.name}\n⏱️ **Duration:** ${minutesDuration} minutes\n🔄 **Return Time:** <t:${Math.floor(returnTime/1000)}:R>`, 
        inline: false 
      },
      {
        name: "Success Chance",
        value: `${successChance}%${isPreferred ? " (includes dinosaur bonus)" : ""}${buffBonus > 0 ? ` (includes ${buffBonus}% potion bonus)` : ""}`,
        inline: false
      }
    )
...
async function completeExpedition(message, userId, displayName, biomeId, expedition) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`${displayName}, your **${expedition.dinosaur}** has returned from the ${biome.name}!`)
    .setThumbnail("https://www.dododex.com/media/item/Artifact_of_the_Hunter.png");
  ...
  if (expedition.success) {
    ...
    const efficiencyMultiplier = (expedition.preferred ? 1.5 : 1) * buffEfficiencyBonus;
    ...
    for (const rareItem of RARE_ITEMS) {
      ...
      if (expedition.skill && (expedition.skill.effect === "rare_find" || expedition.skill.effect === "treasure_detection")) {
    ...
    let resourceList = "";
    for (const resource of resources) {
      resourceList += `${resource.emoji} **${resource.name}** x${resource.amount}${resource.rare ? " ⭐" : ""}\n`;
    }
    ...
    if (buffEfficiencyBonus > 1.0) {
      embed.addFields({
        name: "📈 Active Boost",
        value: `Resource yield increased by ${Math.round((buffEfficiencyBonus - 1) * 100)}% from active potions`,
        inline: false
      });
    }
    ...
    // Failed expedition
    embed.setColor("#e74c3c") // Red for failure
      .addFields({
